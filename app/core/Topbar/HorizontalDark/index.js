      ...
      <Header
        ...
        <div className="gx-container">
          <div className="gx-header-horizontal-main-flex">
            ...
            <Link href="/">
              <img alt=""  className="gx-d-block gx-d-lg-none gx-pointer gx-mr-xs-3 gx-pt-xs-1 gx-w-logo" src={("/images/iconic logo.png")}/></Link>
            <Link href="/">
              <img alt="" className="gx-d-none gx-d-lg-block gx-pointer gx-mr-xs-5 gx-logo" src={("/images/iconic logo.png")}/></Link>
