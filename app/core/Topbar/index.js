...
import UserProfile from "@/app/core/Sidebar/UserProfile";
...
const Topbar = () => {
  ...
  return (
    <Header>
      ...
      <Link href="/">
        <>
          <img src={"/images/iconic logo-title.png"} className="gx-d-block gx-d-lg-none gx-pointer" height="30" width="30" />
        </>
      </Link>
