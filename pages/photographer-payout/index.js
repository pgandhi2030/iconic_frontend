...
const AllClientsPage = (props) => {
    ...
    const fetchPhotographerData = () => {
        setDataLoader(true);
        axios.get('client/photographerPayoutManagementList').then(({ data }) => {
    ...
    {
        title: 'Photographer Total Payment',
        dataIndex: 'photographerTotalPayment',
        key: 'photographerTotalPayment',
        sorter: false,
    },
    {
        title: 'Photographer Pending Payment',
        dataIndex: 'photographerPendingPayment',
        key: 'photographerPendingPayment',
        sorter: false,
    },
    {
        title: 'Action',
        ...
        render: (_id, record) => (
            <Space size="middle">
                {
                    <>
                        <Link href={`/photographer-payout/${_id}`}>
                ...
                <Form name="quotationApprovalForm" layout="vertical" preserve={false} form={quotationApprovalForm} onFinish={onQuotationApproval} scrollToFirstError >
                    ...
                    >
                        ...
                        >
                            ...
                            <Select.Option value={false} key="Reject">Reject</Select.Option>
                        </Select>
                    </Form.Item>
